...
J'ai choisi de créer un **rapport WORD** plutôt qu'un README sur GitHub pour éviter un fichier désorganisé et trop chargé. Le rapport permet une présentation structurée et professionnelle des informations, tout en facilitant la lecture et la navigation.

## Vidéo de Démonstration
Vous pouvez consulter la vidéo de démonstration du processus ici :  
[Vidéo de Démonstration](./documentation/demo.mp4)
